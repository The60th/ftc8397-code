...
@Autonomous(name = "TestCryptoBoxReverseNavigationNew", group = "Test")
//@Disabled
@Disabled
public class TestCryptoBoxReverseNavigationNew extends LinearOpMode {
    ...
    private int rawImgWidth = 1280;
    private int rawImgHeight = 720;
    private int rangeX0 = 40;
    private int rangeY0 = 240;
    private int rangeWidth = 1200;
    private int rangeHeight = 240;
    private float rawFocalLength = 1082f; //THIS NEEDS TO BE CHANGED FOR THE G4; SHOULD BE MORE LIKE 1100; USE GetCameraParameters to find out!!
    private float rawPrincipalX = 640f;
    ...
    public void runOpMode()  {
        ...
        CryptoNavReverse.initParams(CryptoNavNew.TeamColor.RED, rawImgWidth, rawImgHeight, rangeX0, rangeY0, rangeWidth, rangeHeight,
        ...
        while (opModeIsActive()){
            ...
            if(!CryptoNavReverse.initializeRails(imageBytes, CryptoNavNew.Side.LEFT)) break;
        ...
        while (opModeIsActive()) {
            ...
            //wall.
            float[] zx = CryptoNavReverse.updateLocationZX(imageBytes, 0f);
