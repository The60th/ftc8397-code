...
/** Note for jim, make a reverse function here as well? You should be able to use the same code but give it a negtivie for x and drive backwards?*//*
...
/*
    ...
    *//*
    ...
    protected boolean vuforiaBackWardsDemo(int targetIndex, float[] zxPhi, float vNominal, */
/** Note for jim, make a reverse function here as well? You should be able to use the same code but give it a negtivie for x and drive backwards?*//*
